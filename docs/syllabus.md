...
## :material-calendar-month: Schedule
...
<div class="schedule-table" markdown>
...
| 14 Sep | S2 | **AI-assisted research workflow** | [Slides](https://drive.google.com/file/d/1w5nJYDYmcCdq05C53q62bBX3ykfGeiJD/view?usp=drive_link) | [Notebook](https://colab.research.google.com/drive/1OHswkwDQ1th1VjNu2P2pyZ1rFhapoKbB?usp=sharing) | n/a |
...
## :material-clipboard-check: Assessment
...
In-class labs count as attendance, so taking part is what is marked — you are
**not** expected to finish every part in the session. Get as far as you can with
your group and complete the rest in your own time. Missing a session means no
score for that lab, unless you have a good reason such as illness or a family
emergency: tell the instructor or a teaching assistant and it will not count
against you.

!!! warning "Attendance at the final presentations"
    The final project presentations on **14 and 21 December** are compulsory.
    Absence without prior permission costs **10 points — 10% of your final
    grade.** If you cannot attend either date, tell the instructor in advance.

### Bonus

An optional competition will run during the semester, offering extra credit on
top of the marks above. Details coming soon.

## :material-robot: Use of AI-assisted coding
...
!!! example "What a disclosure looks like"
    A sentence is enough. Say which tool you used and what you used it for:

    > This website was built with the assistance of Claude Code, for drafting,
    > formatting, and grammar checks.

    > The training loop was written with GitHub Copilot; I rewrote the loss
    > function myself after the generated version failed a dimensional check.

    The first is not hypothetical — it is the disclosure for this course's own
    site and slides, on the
    [home page](index.md#generative-ai-ethics-statement).

## :material-toolbox: Tools and accounts

- **Accounts:** complete all required accounts by Session 3. Course services,
  notebook-computing options, and NSTC Core limits are on the
  [Resources](resources.md) page.
- **Software:** installation is covered under
  [Software setup](prerequisites.md#software-setup).
- **Version control:** Git is used throughout the course.

## :material-account-multiple: Collaboration and submissions
